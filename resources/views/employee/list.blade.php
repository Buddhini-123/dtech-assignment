...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="add-task">
                <a href="/employees/create" class="btn btn-primary btn-block">Add Employee</a>
            </div>
        </div>
                            ...
                            <div class="card">
                                <div class="card-datatable table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td width="15%">{{ $data->company->name }}</td>
                                            <td width="15%">{{ $data->first_name }}</td>
                                            <td width="15%">{{ $data->last_name }}</td>
